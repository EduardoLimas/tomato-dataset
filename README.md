...
Dataset 01 Source: Rahaman, Tohidur ; Sarkar, Tanmay (2024), “TOMATO”, Mendeley Data, V1, doi: 10.17632/hfyth5t3gg.1
...
train_testsplit.py--> split train and test samples and create the labels for the images
